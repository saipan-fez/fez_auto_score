    ...
    public class SkillOcr : StringOcr
    {
        ...
        public SkillOcr()
        {
            _skillDicionary = new Dictionary<string, byte[]>()
            {
                ...
                { nameof(Resources.Scout_通常攻撃), Resources.Scout_通常攻撃.GenerateHashFromBitmapData() },
                { nameof(Resources.Scout_通常攻撃_S), Resources.Scout_通常攻撃_S.GenerateHashFromBitmapData() },
                ...
                { nameof(Resources.Warrior_アーススタンプ), Resources.Warrior_アーススタンプ.GenerateHashFromBitmapData() },
                { nameof(Resources.Warrior_アーススタンプ_S), Resources.Warrior_アーススタンプ_S.GenerateHashFromBitmapData() },
